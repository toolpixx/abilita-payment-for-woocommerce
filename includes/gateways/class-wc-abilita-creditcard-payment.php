...
class WC_Abilita_CreditCard_Payment extends WC_Abilita_Base_Payment
{
    ...
    public function __construct()
    {
        ...
        $this->id                    = 'abilita-creditcard';
        $this->abilita_payment_name  = 'cc';
        $this->icon                  = plugin_dir_url(false).'abilita-payments-for-woocommerce/assets/images/'.$this->id.'.svg';
        $this->has_fields             = true;
        $this->method_title          = __('abilita PAY (Kreditkarte)', 'abilita-payments-for-woocommerce');
        $this->method_description    = __('Mit der Kreditkarte können Sie schnell und sicher bezahlen und wir können Ihre Bestellung sofort bearbeiten.', 'abilita-payments-for-woocommerce');
        $this->abilita_pay_box_link  = ABILITA_PAYMENT_LINK_HOMEPAGE_OVERVIEW;
        $this->abilita_pay_box_title = __('Kreditkarte', 'abilita-payments-for-woocommerce');
        $this->abilita_pay_box_text  = __('Akzeptieren Sie VISA, Mastercard oder American Express und erreichen Sie internationale Kunden.', 'abilita-payments-for-woocommerce');
        $this->abilita_pay_box_image = $this->icon;
        ...
        add_action('woocommerce_api_abilita-creditcard-success'  , [$this, 'abilita_creditcard_success']);
        add_action('woocommerce_api_abilita-creditcard-error'    , [$this, 'abilita_creditcard_error']);
        add_action('woocommerce_api_abilita-creditcard-postback' , [$this, 'abilita_creditcard_postback']);
    ...
    public function init_form_fields()
    {
        $this->form_fields = [
            ...
            'title' => [
                ...
                'type'        => 'text',
                'default'     => __('Kreditkarte', 'abilita-payments-for-woocommerce'),
    ...
    public function process_payment($orderId)
    {
        ...
        [
            ...
            $error,
            $response
        ] = $abilitaClient->creditcard_payment($this->get_creditcard_payload());
    ...
    public function abilita_creditcard_postback()
    {
        $this->handle_postback(__FUNCTION__);
        $this->handle_response();
    }

    public function abilita_creditcard_success()
    {
        $orderIdGet = '';
    ...
    public function abilita_creditcard_error()
    {
