...
class WC_Abilita_Paypal_Payment extends WC_Abilita_Base_Payment
{
    ...
    public function __construct()
    {
        ...
        $this->id                    = 'abilita-paypal';
        $this->abilita_payment_name  = 'paypal';
        $this->icon                  = plugin_dir_url(false).'abilita-payments-for-woocommerce/assets/images/'.$this->id.'.svg';
        $this->has_fields             = true;
        $this->method_title          = __('abilita PAY (PayPal)', 'abilita-payments-for-woocommerce');
        $this->method_description    = __('Sie zahlen einfach per PayPal. Sie werden nach dem Ausführen der Bestellung zu PayPal weitergeleitet. Nach Abschluss Ihrer Bezahlung gelangen Sie automatisch wieder in den Shop.', 'abilita-payments-for-woocommerce');
        $this->abilita_pay_box_link  = ABILITA_PAYMENT_LINK_HOMEPAGE_OVERVIEW;
        $this->abilita_pay_box_title = __('PayPal', 'abilita-payments-for-woocommerce');
        $this->abilita_pay_box_text  = __('Eine der beliebtesten und vertrauenswürdigsten Zahlungsarten weltweit.', 'abilita-payments-for-woocommerce');
        ...
        add_action('woocommerce_api_abilita-paypal-success'  , [$this, 'abilita_paypal_success']);
        add_action('woocommerce_api_abilita-paypal-error'    , [$this, 'abilita_paypal_error']);
        add_action('woocommerce_api_abilita-paypal-postback' , [$this, 'abilita_paypal_postback']);
    ...
    public function init_form_fields()
    {
        $this->form_fields = [
            ...
            'title' => [
                ...
                'type'        => 'text',
                'default'     => __('PayPal', 'abilita-payments-for-woocommerce'),
    ...
    public function process_payment($orderId)
    {
        ...
        [
            ...
            $error,
            $response
        ] = $abilitaClient->paypal_payment($this->get_paypal_payload());
    ...
    public function abilita_paypal_postback()
    {
        $this->handle_postback(__FUNCTION__);
        $this->handle_response();
    }

    public function abilita_paypal_success()
    {
        $orderIdGet = '';
    ...
    public function abilita_paypal_error()
    {
