    ...
    <table class="form-table" style="margin-bottom:20px;background: white;width:100%;border:15px solid #ececec">
        <tr>
            ...
            <td valign="top">
                ...
                <br><br>
                <a href="<?php echo esc_html(admin_url('admin.php?page=abilita_settings_page&tab=settingsApi')); ?>" target="_blank">Hier gelangen Sie zu den API-Einstellungen</a>
            </td>
        </tr>
    </table>
    <table class="form-table" style="margin-bottom:20px;background: white;width:100%;border:15px solid #ececec">
        <tr>
            ...
            <td valign="top">
                ...
                <br><br>
                <a href="<?php echo esc_html(admin_url('admin.php?page=abilita_settings_page&tab=settingsStatus')); ?>" target="_blank">Hier gelangen Sie zu den Zahlungsstatus-Einstellungen</a>
            </td>
        </tr>
    </table>
    <table class="form-table" style="margin-bottom:20px;background: white;width:100%;border:15px solid #ececec">
